...
class Data extends React.Component {
  ...
  getData = async filter => {
    const pie = await axios.get(`/api/marks?filter=${filter}&type=pie`);
    // Data for pie chart does not need extra formatting
    this.setState({ pieData: pie.data });
    const bar = await axios.get(`/api/marks?filter=${filter}&type=bar`);
          ...
          <div className="data-container">
            ...
            <div className="button-container">
              <div
                ...
                id={this.state.pieChartShow ? "selected" : "unselected"}
              ...
              <div
                ...
                id={this.state.barChartShow ? "selected" : "unselected"}
                onClick={this.toggleChart}
              >
                Bar
              </div>
            ...
            <div
              ...
              id={this.state.pieChartShow ? "pie-container" : "no-show"}
            >
              <Pie options={pieOptions} data={pieChartData} />
            </div>
            <div
              className="chart-container"
              id={this.state.barChartShow ? "bar-container" : "no-show"}
            >
